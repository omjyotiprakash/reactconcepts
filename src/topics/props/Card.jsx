          ...
          users.map((user, idx) => {
            return(
              <div key={idx} className='w-95 h-100 bg-gray-300 rounded-2xl flex items-center justify-center flex-wrap'>
                <div className='w-[95%] h-[30%] overflow-hidde rounded-2xl bg-gradient-to-tr from-amber-200 via-green-200 to-blue-200'>
                ...
                <div className='w-[95%] h-[60%] overflow-hidden rounded-2xl bg-white'>
                  <div className='w-full h-[40%] relative top-10 left-4'>
                    <div className='flex items-center justify-start gap-1'><h1 className='text-xl font-semibold'>{user.name}</h1><MdVerified className='relative top-0.5 text-[blue]' /><button className='bg-black text-white w-[70px] h-[30px] rounded-[5px] shadow-2xl  text-sm absolute right-10'>Follow</button></div>
